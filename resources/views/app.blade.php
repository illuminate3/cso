...
<head>
    ...
    <link rel="shortcut icon" href="http://test.vifx.ru/favicon.ico" type="image/x-icon">
    <link rel="icon" href="http://test.vifx.ru/favicon.ico" type="image/x-icon">

    <!-- Bootstrap -->
    <link id="bootstrap_theme" href="/css/bootstrap.css" rel="stylesheet">
...
<body style="cursor: default;" role="document" id="body">
    ...
    <header>
        <div class="logo">
            <p>
                <a href="/"><img style="display: block; margin-left: auto; margin-right: auto;" src="/images/logo.png" alt="" height="79" width="79"></a>
            </p>
            <p style="text-align: center;"><span style="font-size: small;">Министерство социального развития и</span>
